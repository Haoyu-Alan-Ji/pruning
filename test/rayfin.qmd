...
c_traits <- c_traits[!is.na(c_traits$mating), ]
c_tree <- drop.tip(fish_tree, setdiff(fish_tree$tip.label, c_traits$Species))

c_traits <- c_traits[match(fish_tree_sub$tip.label, c_traits$Species), ]
stopifnot(all(c_tree$tip.label == c_traits$Species))
```
